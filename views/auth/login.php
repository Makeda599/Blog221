    ...
    <div class="max-w-5xl w-full grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
        ...
        <div class="md:col-span-5 bg-white rounded-3xl shadow-xl border border-gray-100 p-6 sm:p-8">
                ...
                <div>
                    <div class="relative">
                        ...
                        <input type="email" name="email" id="email" value="<?=$save["email"] ?? ""?>" placeholder="adresse email" 
                            class="w-full bg-white border border-gray-300 rounded-xl pl-11 pr-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#E562D1]/50 focus:border-[#E562D1] transition placeholder:text-gray-400">
                    </div>
                </div>
                ...
                <div>
                    <div class="relative">
                        ...
                        <input type="password" name="mot_de_passe" id="mot_de_passe" value="<?= $save["mot_de_passe"] ?? "" ?>" placeholder="mot de passe"
                            class="w-full bg-white border border-gray-300 rounded-xl pl-11 pr-12 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#E562D1]/50 focus:border-[#E562D1] transition placeholder:text-gray-400">
                        <button type="button" class="absolute inset-y-0 right-0 flex items-center pr-4 text-gray-400 hover:text-gray-600 transition">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    ...
                    <div class="text-right mt-1.5">
                        <a href="#" class="text-[11px] text-[#E562D1] hover:underline font-medium">Mot de passe oublié ?</a>
                    </div>
                </div>

                <button type="submit" name="envoie"
                    class="w-full bg-[#E562D1] text-white font-medium py-3 rounded-xl hover:bg-[#cb51b7] active:scale-[0.98] transition shadow-md shadow-pink-100 text-sm uppercase tracking-wide mt-2">
                    Se connecter
                </button>
            </form>
            ...
            <div class="relative my-6 text-center">
                ...
                <span class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-3 text-[10px] font-semibold text-gray-400 uppercase tracking-wider">
                    Ou continuer avec
                </span>
            </div>

            <div class="grid grid-cols-2 gap-4">
                <a href="#" class="flex items-center justify-center gap-2 border border-gray-200 rounded-xl py-2.5 hover:bg-gray-50 transition text-xs font-medium text-gray-700 shadow-sm">
